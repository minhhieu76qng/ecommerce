...
const SellerSidebar = () => {
  return (
    <ul id='nav_seller' style={{ margin: '30px 0 0' }}>
      <li>
        <NavLink activeClassName='active' activeClassName='active' className='link' to='/seller/overview'>
      ...
      <li>
        <NavLink activeClassName='active' className='link' to='/seller/products'>
          <ProductsImg className='icon' />
          Products
        </NavLink>
      </li>
      <li>
        <NavLink activeClassName='active' className='link' to='/seller/payments'>
          <PaymentImg className='icon' />
          Payments
        </NavLink>
      </li>
      <li>
        <NavLink activeClassName='active' className='link' to='/seller/promotions'>
